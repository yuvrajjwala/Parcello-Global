...
import SwitchingTextComponent from "./SwitchingTextComponent/SwitchingTextComponent";
    ...
    <Suspense fallback={<div>lOADING</div>}>
      <div className="flex flex-col justify-center items-center px-40 py-5 md:px-20 sm:px-5 relative lg:h-fit  bg-[#008185] overflow-hidden">
        <div className="flex lg:flex-col flex-row justify-center items-center w-full ">
          <h1 className=" font-dm lg:text-center font-bold text-6xl text-white z-10 flex-wrap lg:text-5xl sm:text-4xl mr-4">
            Compare and book <span className=" text-[#FFB526]"> <SwitchingTextComponent/></span>{" "}
            shipping services
          </h1>
